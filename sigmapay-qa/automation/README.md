...
- Tidak ada backend/API sungguhan di baliknya (state di `sessionStorage`) — ini murni UI automation, bukan API automation. Untuk API testing, lihat [Postman API Test Notes](../docs/Postman_API_Test_Notes.html).
